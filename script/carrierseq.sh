...
CarrierSeq="mojarro/carrierseq:0.91"
...
# 11.1 Final seqtk - make fasta file
Cmd="$DockerOption seqtk seq -a"
docker run $Cmd $DockerPath/11_final/carrierseq_bsubtilis.fastq > $DataFolder/11_final/carrierseq_bsubtilis.fasta
